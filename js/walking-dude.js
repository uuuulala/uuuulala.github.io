function setupWalkingDudeAnimation() {
    const dudeContainer = document.querySelector(".animation-dude");
    const tipText = dudeContainer.querySelector(".tip");
    const dudeWrapper = dudeContainer.querySelector("svg");
    const dude = dudeContainer.querySelector(".dude");
